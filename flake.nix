  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      in
      {
        ...
        packages.default = pythonSet.mkVirtualEnv "uv2nix-nbdev-template-env" workspace.deps.default;
            ...
            let
              ...
              editablePythonSet = pythonSet.overrideScope (
                lib.composeManyExtensions [
                  ...
                  (final: prev: {
                    uv2nix-nbdev-template = prev.uv2nix-nbdev-template.overrideAttrs (old: {
                      nativeBuildInputs =
              ...
              virtualenv = editablePythonSet.mkVirtualEnv "uv2nix-nbdev-template-dev-env" workspace.deps.all;
